...
\input{pretextual/folhadeaprovacao.tex}
...
\include{chapters/introduction} 			% Capítulo de introdução
\include{chapters/exampleChapter} 			% Capitulo de exemplo
...
% Conclusão
% ---
\include{chapters/conclusion} 				% Capítulo de introdução
